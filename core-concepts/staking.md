...
{% hint style="warning" %}
If you have staked an account with zero balance, please wait at least 24 hours after funding it to collect staking rewards; or you may miss one day of rewards. (If you staked an account with at least one _HBAR_, you will not be affected by the issue). The issue and details of the sequence of events that trigger this bug can be found [here](https://github.com/hashgraph/hedera-services/issues/4269). Once the fix has been deployed to mainnet, this issue will be resolved.
{% endhint %}
