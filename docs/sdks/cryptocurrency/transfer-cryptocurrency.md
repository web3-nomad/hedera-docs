...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `addHbarTransfer(<accountId>, <value>)`                                             | [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid), HBAR                                                                                                                                         | <p>The account involved in the transfer and the number of hbars.<br><br>The sender and recipient values must net zero.</p>                                                                             |
| `addTokenTransfer(<tokenId>, <accountId>,<value>)`                                  | [TokenId](../tokens/token-id.md), [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid), long                                                                                                       | <p>The ID of the token, the account ID involved in the transfer, and the number of tokens to transfer.<br><br>The sender and recipient values must net zero.</p>                                       |
| `addNftTransfer(<nftId>, <sender>, <receiver>)`                                     | [NftId](../../../sdks-and-apis/sdks/consensus-1/nft-id.md), [AcountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/), [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid) | The NFT ID (token + serial number), the sending account, and receiving account.                                                                                                                        |
...
| `addApprovedHbarTransfer(<ownerAccountId>,<amount>)`                                | [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid), Hbar                                                                                                                                         | <p>The owner account ID the spender is authorized to transfer from and the amount.<br>Applicable to allowance transfers only.</p>                                                                      |
| `addApprovedTokenTransfer(<tokenId>, <accountId>, <value>)`                         | [TokenId](../tokens/token-id.md), [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid), long                                                                                                       | <p>The owner account ID and token the spender is authorized to transfer from. The debiting account is the owner account.<br>Applicable to allowance transfers only.<br></p>                            |
| `addApprovedTokenTransferWithDecimals(<tokenId>, <accountId>, <value>, <decimals>)` | [TokenId](../tokens/token-id.md), [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid), long, int                                                                                                  | <p>The owner account ID and token ID (with decimals) the spender is authorized to transfer from. The debit account is the account ID of the sender.<br>Applicable to allowance transfers only.<br></p> |
| `addApprovedNftTransfer(<nftId>,<sender>, <receiver>)`                              | [NftId](../../../sdks-and-apis/sdks/consensus-1/nft-id.md), [AcountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/), [AccountId](../../../sdks-and-apis/sdks/deprecated/errors-1/specialized-types-1/#accountid) | <p>The NFT ID the spender is authorized to transfer. The sender is the owner account and receiver is the receiving account.<br>Applicable to allowance transfers only.</p>                             |
