...
For non-fungible tokens, the token ID represents a NFT class. Once the token is created, you will have to mint each NFT using the [token mint](../../../tokens/mint-a-token.md) operation.
...
| **Fee Schedule Key**   | The key that can change the token's [custom fee](../../../tokens/custom-token-fees.md) schedule. A custom fee schedule token without a fee schedule key is immutable.                                                                                                                                                                                                                                           |
...
| **Custom Fees**        | [Custom fees](../../../tokens/custom-token-fees.md) to charge during a token transfer transaction that transfers units of this token. Custom fees can either be [fixed](../../../tokens/custom-token-fees.md#fixed-fee), [fractional](../../../tokens/custom-token-fees.md#fractional-fee), or [royalty](../../../tokens/custom-token-fees.md#royalty-fee) fees. You can set up to a maximum of 10 custom fees. |
...
| `setTokenType(<tokenType>)`           | [TokenType](../../../tokens/token-types.md)                                                                                           | Optional    |
