...
Short for operation codes, [opcodes](https://github.com/hashgraph/hedera-docs/blob/l10n\_translation-staging/es/support-and-community/broken-reference/README.md) are the low-level human-readable instructions of the program.
