...
<img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/scaffold-project-expected-output.png" alt="Scaffold project expected output" data-size="original">
...
<img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/copy-walletconnect-string-dapp.png" alt="Walletconnect modal" data-size="original">

Open HashPack and connect to DApp by clicking on the world in the upper right

<img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/connect-to-dapp.png" alt="HashPack connect to dapp modal" data-size="original">

Paste the walletconnect string into HashPack pairing string textbox

<img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/paste-walletconnect-string-dapp.png" alt="HashPack paste pairing string" data-size="original">

Select the Receiver account to connect with the DApp

<img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/hashpack-select-account-dapp.png" alt="HashPack select account" data-size="original">
...
<figure><img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/es/es/.gitbook/assets/transfer-nft-dapp.png" alt="Homepage showing the transfer of NFT serial number 5"><figcaption><p>Transfer NFT to Receiver Account</p></figcaption></figure>
