...
Please refer to [SDKs](https://github.com/hashgraph/hedera-docs/blob/l10n\_translation-staging/fr/fr/hedera/sdks-and-apis/sdks/README.md) for an up to date list of SDKs, including additional community-maintained SDKs.
...
* ✅ Complete the [Introduction](https://github.com/hashgraph/hedera-docs/blob/l10n\_translation-staging/fr/fr/tutorials/smart-contracts/hscs-workshop/00-intro.md) section of this same tutorial.
...
<figure><img src="https://github.com/hashgraph/hedera-docs/blob/l10n_translation-staging/fr/fr/.gitbook/assets/hashscan--transaction--logs.png" alt="Screenshot showing Logs - Transaction (on hashscan.io)."><figcaption><p>Screenshot showing Logs - Transaction (on hashscan.io).</p></figcaption></figure>
