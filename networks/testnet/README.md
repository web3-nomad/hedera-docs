...
* Mirror Node operators can reference the instructions [here](https://github.com/hashgraph/hedera-mirror-node/blob/main/docs/database/README.md#reset) to set-up your mirror node
  * GCP GCS and AWS S3 buckets: `hedera-testnet-streams-2024-02`
