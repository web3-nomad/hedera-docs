...
At a functional level, Stablecoin Studio provides a comprehensive architecture that enables developers to create, manage, and operate stablecoins on the Hedera network using pre-built “factory smart contracts” that have been [audited by CertiK.](https://github.com/hashgraph/hedera-accelerator-stablecoin/blob/main/Certik%20final%20smart%20contracts%20audit%20report.pdf) The architecture consists of several components that work together to facilitate the deployment and management of stablecoins:
