...
| ------------------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------- | ----------- |
| `setContractId(<contractId>)`               | [ContractId](../../sdks/deprecated/errors-1/specialized-types-1/#contractid) | Sets the contract ID (x.z.y) which should be deleted.                | Required    |
| `setTransferAccountId(<transferAccountId>)` | [AccountId](../../sdks/deprecated/errors-1/specialized-types-1/#accountid)   | Sets the account ID (x.z.y) which will receive all remaining hbars   | Optional    |
| `setTransferContractId(<contractId>)`       | [ContractId](../../sdks/deprecated/errors-1/specialized-types-1/#contractid) | Sets the contract ID (x.z.y) which will receive all remaining hbars. | Optional    |
