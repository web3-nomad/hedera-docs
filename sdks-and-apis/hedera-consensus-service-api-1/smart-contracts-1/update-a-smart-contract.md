...
| ------------------------------------------------- | ---------------------------------------------------------------------------- | ----------- |
| `setContractId(<contractId>)`                     | [ContractId](../../sdks/deprecated/errors-1/specialized-types-1/#contractid) | Required    |
...
| Method                      | Type                                                                         | Requirement |
| --------------------------- | ---------------------------------------------------------------------------- | ----------- |
| `getContractId()`           | [ContractId](../../sdks/deprecated/errors-1/specialized-types-1/#contractid) | Required    |
| `getAdminKey()`             | Key                                                                          | Optional    |
| `getBytecodeFileId()`       | [FileId](../../sdks/deprecated/errors-1/specialized-types-1/#fileid)         | Optional    |
| `getProxyAccountId()`       | [AccountId](../../sdks/deprecated/errors-1/specialized-types-1/#accountid)   | Optional    |
