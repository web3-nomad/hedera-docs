...
For non-fungible tokens, the token ID represents a NFT class. Once the token is created, you will have to mint each NFT using the [token mint](../../sdks/consensus-service/mint-a-token.md) operation.
...
| **Fee Schedule Key**   | The key that can change the token's [custom fee](../../sdks/consensus-1/custom-token-fees.md) schedule. A custom fee schedule token without a fee schedule key is immutable.                                                                                                                                                                                                                                                                |
...
| **Custom Fees**        | [Custom fees](../../sdks/consensus-1/custom-token-fees.md) to charge during a token transfer transaction that transfers units of this token. Custom fees can either be [fixed](../../sdks/consensus-1/custom-token-fees.md#fixed-fee), [fractional](../../sdks/consensus-1/custom-token-fees.md#fractional-fee), or [royalty](../../sdks/consensus-1/custom-token-fees.md#royalty-fee) fees. You can set up to a maximum of 10 custom fees. |
...
| `setTokenType(<tokenType>)`           | [TokenType](../../sdks/consensus-1/token-types.md)                                                                                    | Optional    |
| `setSymbol(<symbol>)`                 | String                                                                                                                                | Required    |
| `setDecimals(<decimal>)`              | int                                                                                                                                   | Optional    |
| `setInitialSupply(<initialSupply>)`   | int                                                                                                                                   | Optional    |
| `setTreasury(<treasury>)`             | [AccountId](../../sdks/deprecated/errors-1/specialized-types-1/#accountid)                                                            | Required    |
| `setAdminKey(<key>)`                  | [PublicKey](../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md)                                                           | Required    |
| `setKycKey(<key>)`                    | [PublicKey](../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md)                                                           | Optional    |
| `setFreezeKey(<key>)`                 | [PublicKey](../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md)                                                           | Optional    |
| `setWipeKey(<key>)`                   | [PublicKey](../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md)                                                           | Optional    |
| `setSupplyKey(<key>)`                 | [PublicKey](../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md)                                                           | Optional    |
...
| `setAutoRenewAccount(<account>)`      | [AccountId](../../sdks/deprecated/errors-1/specialized-types-1/#accountid)                                                            | Optional    |
