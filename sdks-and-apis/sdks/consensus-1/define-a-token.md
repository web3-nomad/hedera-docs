...
For non-fungible tokens, the token ID represents a NFT class. Once the token is created, you will have to mint each NFT using the [token mint](../consensus-service/mint-a-token.md) operation.
...
| `setTreasuryAccountId(<treasury>)`    | [AccountId](../deprecated/errors-1/specialized-types.md#accountid) | Required    |
...
| `setAutoRenewAccountId(<account>)`    | [AccountId](../deprecated/errors-1/specialized-types.md#accountid) | Disabled    |
