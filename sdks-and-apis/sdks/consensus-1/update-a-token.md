...
| ------------------------------------- | ------------------------------------------------------------------ | ----------- |
| `setTokenId(<tokenId>)`               | [TokenId](../../../docs/sdks/tokens/token-id.md)                   | Required    |
| `setTokenName(<name>)`                | String                                                             | Optional    |
| `setTokenSymbol(<symbol>)`            | String                                                             | Optional    |
| `setTreasuryAccountId(<treasury>)`    | [AccountId](../deprecated/errors-1/specialized-types-1/#accountid) | Optional    |
...
| `setAutoRenewAccountId(<account>)`    | [AccountId](../deprecated/errors-1/specialized-types-1/#accountid) | Disabled    |
