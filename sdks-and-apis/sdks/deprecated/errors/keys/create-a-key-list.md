...
Create a key list key structure where all the keys in the list are required to sign transactions that modify accounts, topics, tokens, smart contracts, or files. A key \*\*\*\* list can contain a [Ed25519](../../../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md#ed25519) or [ECDSA](../../../../../core-concepts/mirror-nodes/generate-a-new-key-pair.md#ecdsa-secp256k1) (secp256k1\_)\_ key type.
