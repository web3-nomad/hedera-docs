...
A consensus mechanism in which an individual runs distributed ledger software (a “consensus node”) responsible for processing transactions, blocks, and the state of the network.
