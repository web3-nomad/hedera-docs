...
You can alternatively use the [<mark style="color:purple;">`CreateContractFlow()`</mark>](../../apis-and-sdks/sdks/smart-contracts/create-a-smart-contract.md#contractcreateflow) API that creates the bytecode file for you and subsequently creates the contract on Hedera in a single API.
