...
By the way, [this resource](https://www.wolfssl.com/true-random-vs-pseudorandom-number-generation/) is helpful if you want to learn more about the difference between pseudorandom and random numbers. For simplicity, we’ll use both terms interchangeably throughout this tutorial.
...
* Get a [Hedera testnet account](https://portal.hedera.com/register)
  ...
  * If you’re new to Hedera, check out [these steps to setup your development environment](https://docs.hedera.com/guides/getting-started/environment-set-up)
