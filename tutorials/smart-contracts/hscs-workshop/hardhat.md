...
* If it does not exist, or does not have balance, you'll need to create or fund it before proceeding
  * To do so, you'll need to repeat [_Step B4: Fund several Hedera EVM accounts_](setup.md#step-b4-fund-several-hedera-evm-accounts) from the Setup section of this tutorial.
